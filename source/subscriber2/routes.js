...
router.post("/subscribe", function(req, res){
    ...
    axios.post("http://broker-service-1:8081/subscribe",data,{'Content-type':'application/json'})
...
router.post("/unsubscribe", function(req, res){
    ...
    axios.post("http://broker-service-1:8081/unsubscribe",data,{'Content-type':'application/json'})
    .then(res => console.log(res.status))
    .catch(err => console.log(err));
    res.sendStatus(200);
});
...
router.post("/advertise", function(req,res){
    ...
    axios.post("http://broker-service-1:8081/advertise",data,{'Content-type':'application/json'})
    .then(res => console.log(res.status))
    .catch(err => console.log(err));
    res.sendStatus(200);
});
...
router.post("/de_advertise", function (req, res) {
    ...
    axios.post("http://broker-service-1:8081/de_advertise",data,{'Content-type':'application/json'})
    .then(res => console.log(res.status))
    .catch(err => console.log(err));
    res.sendStatus(200);
});
