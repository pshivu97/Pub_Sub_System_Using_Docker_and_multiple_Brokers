...
router.post("/advertise", function(req,res){
    ...
    axios.post("http://broker-service:8080/advertise",data,{'Content-type':'application/json'})
    .then(res => console.log(res.status))
    .catch(err => console.log(err));
    res.sendStatus(200);
});
...
router.post("/de_advertise", function (req, res) {
    ...
    axios.post("http://broker-service:8080/de_advertise",data,{'Content-type':'application/json'})
    .then(res => console.log(res.status))
    .catch(err => console.log(err));
    res.sendStatus(200);
});
