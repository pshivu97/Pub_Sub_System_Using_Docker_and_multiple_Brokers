...
var self_details = { 'topics': ['chicken', 'fish'], 'port': 8080, 'host_name': 'broker-service' }
var neighbour_node_details = [{ 'port': 8081, 'host_name': 'broker-service-1' },{'port':8082,'host_name':'broker-service-2'} ]
...
function subsrcibeData(data) {
    ...
    //     data['isFromBroker'] = true
    //     console.log("Jumping to broker" + JSON.stringify(broker_detail))
